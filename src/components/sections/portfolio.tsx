...
export const Portfolio: React.FC = () => {
  ...
  // Limit landing page to first 3 projects (makes them larger in a 3-column layout)
  const landingProjects = portfolioData.slice(0, 3);
    ...
    <section id="portfolio" className="bg-zinc-950 py-32 px-6 relative z-10">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col items-center text-center mb-24">
          ...
          <h2 className="text-3xl md:text-5xl font-light text-zinc-100 tracking-tight leading-snug max-w-3xl">
            Katalog Portofolio & Rekayasa Arsitektur Sistem
          </h2>
          ...
          <div className="flex justify-center mt-16">
            <Link
              ...
              className={cn(
                ...
                "py-3 px-8 rounded-sm text-sm font-semibold tracking-wide cursor-pointer"
              )}
            >
              Lihat Semua Projek
            </Link>
