...
function extendMaterial(
  BaseMaterial: new (args?: THREE.MeshStandardMaterialParameters) => THREE.MeshStandardMaterial,
  cfg: MaterialConfig
  ...
  const uniforms = THREE.UniformsUtils.clone(baseUniforms) as Record<string, { value: unknown }>;
...
const MergedPlanes = forwardRef<THREE.Mesh, MergedPlanesProps>(({ material, width, count, height }, ref) => {
  ...
  return <mesh ref={localMeshRef} geometry={geometry} material={material} />;
});
